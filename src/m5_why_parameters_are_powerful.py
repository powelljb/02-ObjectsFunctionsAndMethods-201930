...
def main():
    ...
    even_better_draw_circles(rg.Point(-200,0), 30, 15, 'green', 7)
    even_better_draw_circles(rg.Point(-200,0), 20, 12, 'pink', 9)
    even_better_draw_circles(rg.Point(100, 50), 20, 10, 'cyan', 8)
    even_better_draw_circles(rg.Point(300,50), 20, 15, 'yellow', 5)
    even_better_draw_circles(rg.Point(350,50), 20, 15, 'yellow', 5)
    even_better_draw_circles(rg.Point(400,50), 20, 15, 'yellow', 5)
...
def even_better_draw_circles(point, radii, number, color, thickness):
    ...
    for number in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(radii * number)  # Radius 15, 30, 45, 60, ...
        #---------------------------------------------------------------------
        # The above function uses 5 parameters to make a more powerful version of the draw circles function.
        # This functions is improved as it can adjust color and thickness to add style.
        # The functions used within this function include draw circle
